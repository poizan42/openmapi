//
// openmapi.org - NMapi C# Mapi API - Mask.cs
//
...
namespace NMapi.Tools.Shell {
	...
	public sealed class MaskCommand : AbstractBaseCommand
	{
		...
		public MaskCommand (Driver driver, ShellState state) : base (driver, state)
		{
		}
