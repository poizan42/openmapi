//
// openmapi.org - NMapi C# Mapi API - Mkdir.cs
//
...
namespace NMapi.Tools.Shell {
	...
	public sealed class MkdirCommand : AbstractBaseCommand
	{
		...
		public MkdirCommand (Driver driver, ShellState state) : base (driver, state)
		{
		}
