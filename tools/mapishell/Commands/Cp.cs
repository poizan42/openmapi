//
// openmapi.org - NMapi C# Mapi API - Cp.cs
//
...
namespace NMapi.Tools.Shell {
	...
	public sealed class CpCommand : AbstractBaseCommand
	{
		...
		public CpCommand (Driver driver, ShellState state) : base (driver, state)
		{
		}
		...
		public override void Run (CommandContext context)
		{
			...
			state.CopyOrMove (srcPath, destPath, false);
		}
