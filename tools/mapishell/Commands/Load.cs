//
// openmapi.org - NMapi C# Mapi API - Load.cs
//
...
namespace NMapi.Tools.Shell {
	...
	public sealed class LoadCommand : AbstractBaseCommand
	{
		...
		public LoadCommand (Driver driver, ShellState state) : base (driver, state)
		{
		}
