...
namespace NMapi.Tools.Shell {
	...
	public sealed class PropsCommand : AbstractBaseCommand
	{
		...
		public override string Description {
			get {
				return " List the Properties of an object";
			}
		}
		...
		public PropsCommand (Driver driver, ShellState state) : base (driver, state)
		{
		}
