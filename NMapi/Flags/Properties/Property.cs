...
namespace NMapi.Flags {
	...
	public struct Property
	{
		...
		[MapiPropDef] public const int AcknowledgementMode                      =  ((int) PropertyType.Int32)    | (0x0001 << 16);
		...
		[MapiPropDef] public const int AutoForwardComment                       =  ((int) PropertyType.Unicode) | (0x0004 << 16);
		...
		[MapiPropDef] public const int ContentIdentifier                        =  ((int) PropertyType.Unicode) | (0x0008 << 16);
		...
		[MapiPropDef] public const int ContentLength                            =  ((int) PropertyType.Int32)    | (0x0009 << 16);
		...
		[MapiPropDef] public const int DiscardReason                            =  ((int) PropertyType.Int32)    | (0x0011 << 16);
		...
		[MapiPropDef] public const int Importance                               =  ((int) PropertyType.Int32)    | (0x0017 << 16);
		...
		[MapiPropDef] public const int MessageClass                             =  ((int) PropertyType.Unicode) | (0x001A << 16);
		...
		[MapiPropDef] public const int Priority                                 =  ((int) PropertyType.Int32)    | (0x0026 << 16);
		...
		[MapiPropDef] public const int OriginalSensitivity                      =  ((int) PropertyType.Int32)    | (0x002E << 16);
		[MapiPropDef] public const int Languages                                =  ((int) PropertyType.Unicode) | (0x002F << 16);
		...
		[MapiPropDef] public const int Security                                 =  ((int) PropertyType.Int32)    | (0x0034 << 16);
		[MapiPropDef] public const int IncompleteCopy                           =  ((int) PropertyType.Boolean) | (0x0035 << 16);
		[MapiPropDef] public const int Sensitivity                              =  ((int) PropertyType.Int32)    | (0x0036 << 16);
		[MapiPropDef] public const int Subject                                  =  ((int) PropertyType.Unicode) |  ( 0x0037 << 16);
		...
		[MapiPropDef] public const int ReportName                               =  ((int) PropertyType.Unicode) | (0x003A << 16);
		...
		[MapiPropDef] public const int SubjectPrefix                            =  ((int) PropertyType.Unicode) | (0x003D << 16);
		...
		[MapiPropDef] public const int NonReceiptReason                         =  ((int) PropertyType.Int32)    | (0x003E << 16);
		[MapiPropDef] public const int ReceivedByEntryId                        =  ((int) PropertyType.Binary)  | ( 0x003F << 16);
		[MapiPropDef] public const int ReceivedByName                           =  ((int) PropertyType.Unicode) | (0x0040 << 16);
		...
		[MapiPropDef] public const int SentRepresentingName                     =  ((int) PropertyType.Unicode) | (0x0042 << 16);
		...
		[MapiPropDef] public const int RcvdRepresentingName                     =  ((int) PropertyType.Unicode) | (0x0044 << 16);
		...
		[MapiPropDef] public const int OriginalSubject                          =  ((int) PropertyType.Unicode) | (0x0049 << 16);
		...
		[MapiPropDef] public const int OrigMessageClass                         =  ((int) PropertyType.Unicode) | (0x004B << 16);
		...
		[MapiPropDef] public const int OriginalAuthorName                       =  ((int) PropertyType.Unicode) | (0x004D << 16);
		...
		[MapiPropDef] public const int ReplyRecipientNames                      =  ((int) PropertyType.Unicode) | (0x0050 << 16);
		...
		[MapiPropDef] public const int OriginalSenderName                       =  ((int) PropertyType.Unicode) | (0x005A << 16);
		...
		[MapiPropDef] public const int OriginalSentRepresentingName             =  ((int) PropertyType.Unicode) | (0x005D << 16);
		...
		[MapiPropDef] public const int OwnerApptId                              =  ((int) PropertyType.Int32)    | (0x0062 << 16);
		[MapiPropDef] public const int ResponseRequested                        =  ((int) PropertyType.Boolean) | (0x0063 << 16);

		[MapiPropDef] public const int SentRepresentingAddrType                 =  ((int) PropertyType.Unicode) | (0x0064 << 16);
		...
		[MapiPropDef] public const int SentRepresentingEmailAddress             =  ((int) PropertyType.Unicode) | (0x0065 << 16);
		...
		[MapiPropDef] public const int OriginalSenderAddrType                   =  ((int) PropertyType.Unicode) | (0x0066 << 16);
		...
		[MapiPropDef] public const int OriginalSenderEmailAddress               =  ((int) PropertyType.Unicode) | (0x0067 << 16);
		...
		[MapiPropDef] public const int OriginalSentRepresentingAddrType         =  ((int) PropertyType.Unicode) | (0x0068 << 16);
		...
		[MapiPropDef] public const int OriginalSentRepresentingEmailAaddress    =  ((int) PropertyType.Unicode) | (0x0069 << 16);
		...
		[MapiPropDef] public const int ConversationTopic                        =  ((int) PropertyType.Unicode) | (0x0070 << 16);
		...
		[MapiPropDef] public const int OriginalDisplayBcc                       =  ((int) PropertyType.Unicode) | (0x0072 << 16);
		...
		[MapiPropDef] public const int OriginalDisplayCc                        =  ((int) PropertyType.Unicode) | (0x0073 << 16);
		...
		[MapiPropDef] public const int OriginalDisplayTo                        =  ((int) PropertyType.Unicode) | (0x0074 << 16);
		...
		[MapiPropDef] public const int ReceivedByAddrType                       =  ((int) PropertyType.Unicode) | (0x0075 << 16);
		...
		[MapiPropDef] public const int ReceivedByEmailAddress                   =  ((int) PropertyType.Unicode) | (0x0076 << 16);
		...
		[MapiPropDef] public const int RcvdRepresentingAddrType                 =  ((int) PropertyType.Unicode) | (0x0077 << 16);
		...
		[MapiPropDef] public const int RcvdRepresentingEmailAddress             =  ((int) PropertyType.Unicode) | (0x0078 << 16);
		...
		[MapiPropDef] public const int OriginalAuthorAddrType                   =  ((int) PropertyType.Unicode) | (0x0079 << 16);
		...
		[MapiPropDef] public const int OriginalAuthorEmailAddress               =  ((int) PropertyType.Unicode) | (0x007A << 16);
		...
		[MapiPropDef] public const int OriginallyIntendedRecipAddrType          =  ((int) PropertyType.Unicode) | (0x007B << 16);
		...
		[MapiPropDef] public const int OriginallyIntendedRecipEmailAddress      =  ((int) PropertyType.Unicode) | (0x007C << 16);
		...
		[MapiPropDef] public const int TransportMessageHeaders                  =  ((int) PropertyType.Unicode) | ( 0x007D << 16);
		...
		[MapiPropDef] public const int Body                                     =  ((int) PropertyType.Unicode) | (0x1000 << 16);
		...
		[MapiPropDef] public const int ReportText                               =  ((int) PropertyType.Unicode) | (0x1001 << 16);
		...
		[MapiPropDef] public const int RtfSyncBodyCrc                           =  ((int) PropertyType.Int32)    | (0x1006 << 16);
		[MapiPropDef] public const int RtfSyncBodyCount                         =  ((int) PropertyType.Int32)    | (0x1007 << 16);
		[MapiPropDef] public const int RtfSyncBodyTag                           =  ((int) PropertyType.Unicode) | (0x1008 << 16);
		...
		[MapiPropDef] public const int RtfSyncPrefixCount                       =  ((int) PropertyType.Int32)    | (0x1010 << 16);
		[MapiPropDef] public const int RtfSyncTrailingCount                     =  ((int) PropertyType.Int32)    | (0x1011 << 16);
		...
		[MapiPropDef] public const int ExplicitConversion                       =  ((int) PropertyType.Int32)    | (0x0C01 << 16);
		...
		[MapiPropDef] public const int NdrReasonCode                            =  ((int) PropertyType.Int32)    | (0x0C04 << 16);
		[MapiPropDef] public const int NdrDiagCode                              =  ((int) PropertyType.Int32)    | (0x0C05 << 16);
		[MapiPropDef] public const int NonReceiptNotificationRequested          =  ((int) PropertyType.Boolean) | (0x0C06 << 16);
		[MapiPropDef] public const int DeliveryPoint                            =  ((int) PropertyType.Int32)    | (0x0C07 << 16);
		...
		[MapiPropDef] public const int PhysicalDeliveryMode                     =  ((int) PropertyType.Int32)    | (0x0C0B << 16);
		[MapiPropDef] public const int PhysicalDeliveryReportRequest            =  ((int) PropertyType.Int32)    | (0x0C0C << 16);
		...
		[MapiPropDef] public const int RecipientNumberForAdvice                 =  ((int) PropertyType.Unicode) | (0x0C14 << 16);
		...
		[MapiPropDef] public const int RecipientType                            =  ((int) PropertyType.Int32)    | (0x0C15 << 16);
		[MapiPropDef] public const int RegisteredMailType                       =  ((int) PropertyType.Int32)    | (0x0C16 << 16);
		[MapiPropDef] public const int ReplyRequested                           =  ((int) PropertyType.Boolean) | (0x0C17 << 16);
		[MapiPropDef] public const int RequestedDeliveryMethod                  =  ((int) PropertyType.Int32)    | (0x0C18 << 16);
		[MapiPropDef] public const int SenderEntryId                            =  ((int) PropertyType.Binary)  | ( 0x0C19 << 16);
		[MapiPropDef] public const int SenderName                               =  ((int) PropertyType.Unicode) | (0x0C1A << 16);
		...
		[MapiPropDef] public const int SupplementaryInfo                        =  ((int) PropertyType.Unicode) | (0x0C1B << 16);
		...
		[MapiPropDef] public const int TypeOfMtsUser                            =  ((int) PropertyType.Int32)    | (0x0C1C << 16);
		[MapiPropDef] public const int SenderSearchKey                          =  ((int) PropertyType.Binary)  | ( 0x0C1D << 16);
		[MapiPropDef] public const int SenderAddrType                           =  ((int) PropertyType.Unicode) | (0x0C1E << 16);
		...
		[MapiPropDef] public const int SenderEmailAddress                       =  ((int) PropertyType.Unicode) | (0x0C1F << 16);
		...
		[Obsolete]
		[MapiPropDef] public const int CurrentVersion                           =  ((int) PropertyType.Int64)      | (0x0E00 << 16);

		[MapiPropDef] public const int DeleteAfterSubmit                        =  ((int) PropertyType.Boolean) | (0x0E01 << 16);
		[MapiPropDef] public const int DisplayBcc                               =  ((int) PropertyType.Unicode) | (0x0E02 << 16);
		...
		[MapiPropDef] public const int DisplayCc                                =  ((int) PropertyType.Unicode) | (0x0E03 << 16);
		...
		[MapiPropDef] public const int DisplayTo                                =  ((int) PropertyType.Unicode) | (0x0E04 << 16);
		...
		[MapiPropDef] public const int ParentDisplay                            =  ((int) PropertyType.Unicode) | (0x0E05 << 16);
		...
		[MapiPropDef] public const int MessageFlags                             =  ((int) PropertyType.Int32)    | (0x0E07 << 16);
		[MapiPropDef] public const int MessageSize                              =  ((int) PropertyType.Int32)    | (0x0E08 << 16);
		...
		[MapiPropDef] public const int SpoolerStatus                            =  ((int) PropertyType.Int32)    | (0x0E10 << 16);

		[Obsolete]
		[MapiPropDef] public const int TransportStatus                          =  ((int) PropertyType.Int32)    | (0x0E11 << 16);
		...
		[MapiPropDef] public const int SubmitFlags                              =  ((int) PropertyType.Int32)    | (0x0E14 << 16);
		[MapiPropDef] public const int RecipientStatus                          =  ((int) PropertyType.Int32)    | (0x0E15 << 16);
		[MapiPropDef] public const int TransportKey                             =  ((int) PropertyType.Int32)    | (0x0E16 << 16);
		[MapiPropDef] public const int MsgStatus                                =  ((int) PropertyType.Int32)    | (0x0E17 << 16);
		[MapiPropDef] public const int MessageDownloadTime                      =  ((int) PropertyType.Int32)    | (0x0E18 << 16);

		[Obsolete]
		[MapiPropDef] public const int CreationVersion                          =  ((int) PropertyType.Int64)      | (0x0E19 << 16);

		[Obsolete]
		[MapiPropDef] public const int ModifyVersion                            =  ((int) PropertyType.Int64)      | (0x0E1A << 16);

		[MapiPropDef] public const int HasAttach                                =  ((int) PropertyType.Boolean) | (0x0E1B << 16);
		[MapiPropDef] public const int BodyCrc                                  =  ((int) PropertyType.Int32)    | (0x0E1C << 16);
		[MapiPropDef] public const int NormalizedSubject                        =  ((int) PropertyType.Unicode) | (0x0E1D << 16);
		...
		[MapiPropDef] public const int AttachSize                               =  ((int) PropertyType.Int32)    | (0x0E20 << 16);
		[MapiPropDef] public const int AttachNum                                =  ((int) PropertyType.Int32)    | (0x0E21 << 16);
		...
		[MapiPropDef] public const int ObjectType                               =  ((int) PropertyType.Int32)    | (0x0FFE << 16);
		...
		[MapiPropDef] public const int AccessLevel                              =  ((int) PropertyType.Int32)    | (0x0FF7 << 16);
		[MapiPropDef] public const int InstanceKey                              =  ((int) PropertyType.Binary)  | (0x0FF6 << 16);
		[MapiPropDef] public const int RowType                                  =  ((int) PropertyType.Int32)    | (0x0FF5 << 16);
		[MapiPropDef] public const int Access                                   =  ((int) PropertyType.Int32)    | (0x0FF4 << 16);

		[MapiPropDef] public const int RowId                                    =  ((int) PropertyType.Int32)    | (0x3000 << 16);
		[MapiPropDef] public const int DisplayName                              =  ((int) PropertyType.Unicode) | (0x3001 << 16);
		...
		[MapiPropDef] public const int AddrType                                 =  ((int) PropertyType.Unicode) | (0x3002 << 16);
		...
		[MapiPropDef] public const int EmailAddress                             =  ((int) PropertyType.Unicode) | (0x3003 << 16);
		...
		[MapiPropDef] public const int Comment                                  =  ((int) PropertyType.Unicode) | (0x3004 << 16);
		...
		[MapiPropDef] public const int Depth                                    =  ((int) PropertyType.Int32)    | (0x3005 << 16);
		[MapiPropDef] public const int ProviderDisplay                          =  ((int) PropertyType.Unicode) | (0x3006 << 16);
		...
		[MapiPropDef] public const int ResourceFlags                            =  ((int) PropertyType.Int32)    | (0x3009 << 16);
		[MapiPropDef] public const int ProviderDllName                          =  ((int) PropertyType.Unicode) | (0x300A << 16);
		...
		[MapiPropDef] public const int ProviderOrdinal                          =  ((int) PropertyType.Int32)    | (0x300D << 16);

		//
		//  MAPI Form
		//

		[MapiPropDef] public const int FormVersion                              =  ((int) PropertyType.Unicode) | (0x3301 << 16);
		...
		[MapiPropDef] public const int FormContactName                          =  ((int) PropertyType.Unicode) | (0x3303 << 16);
		...
		[MapiPropDef] public const int FormCategory                             =  ((int) PropertyType.Unicode) | (0x3304 << 16);
		...
		[MapiPropDef] public const int FormCategorySub                          =  ((int) PropertyType.Unicode) | (0x3305 << 16);
		...
		[MapiPropDef] public const int FormHostMap                              =  ((int) PropertyType.MvInt32)  | (0x3306 << 16);
		[MapiPropDef] public const int FormHidden                               =  ((int) PropertyType.Boolean) | (0x3307 << 16);
		[MapiPropDef] public const int FormDesignerName                         =  ((int) PropertyType.Unicode) | (0x3308 << 16);
		...
		[MapiPropDef] public const int FormMessageBehavior                      =  ((int) PropertyType.Int32)    | (0x330A << 16);
		...
		[MapiPropDef] public const int StoreSupportMask                         =  ((int) PropertyType.Int32)    | (0x340D << 16);
		[MapiPropDef] public const int StoreState                               =  ((int) PropertyType.Int32)    | (0x340E << 16);
		...
		[MapiPropDef] public const int ValidFolderMask                          =  ((int) PropertyType.Int32)    | (0x35DF << 16);
		...
		[MapiPropDef] public const int ContainerFlags                           =  ((int) PropertyType.Int32)    | (0x3600 << 16);
		[MapiPropDef] public const int FolderType                               =  ((int) PropertyType.Int32)    | (0x3601 << 16);
		[MapiPropDef] public const int ContentCount                             =  ((int) PropertyType.Int32)    | (0x3602 << 16);
		[MapiPropDef] public const int ContentUnread                            =  ((int) PropertyType.Int32)    | (0x3603 << 16);
		...
		[MapiPropDef] public const int Status                                   =  ((int) PropertyType.Int32)    | (0x360B << 16);
		[MapiPropDef] public const int Anr                                      =  ((int) PropertyType.Unicode) | (0x360C << 16);
		...
		[Obsolete]
		[MapiPropDef] public const int ContentsSortOrder                        =  ((int) PropertyType.MvInt32)  | (0x360D << 16);
		...
		[MapiPropDef] public const int ContainerClass                           =  ((int) PropertyType.Unicode) | (0x3613 << 16);
		...
		[Obsolete]
		[MapiPropDef] public const int ContainerModifyVersion                   =  ((int) PropertyType.Int64)      | (0x3614 << 16);
		...
		[MapiPropDef] public const int AssocContentCount                        =  ((int) PropertyType.Int32)    | (0x3617 << 16);
		...
		[MapiPropDef] public const int AttachExtension                          =  ((int) PropertyType.Unicode) | (0x3703 << 16);
		...
		[MapiPropDef] public const int AttachFilename                           =  ((int) PropertyType.Unicode) | (0x3704 << 16);
		...
		[MapiPropDef] public const int AttachMethod                             =  ((int) PropertyType.Int32)    | (0x3705 << 16);
		[MapiPropDef] public const int AttachLongFilename                       =  ((int) PropertyType.Unicode) | (0x3707 << 16);
		...
		[MapiPropDef] public const int AttachPathname                           =  ((int) PropertyType.Unicode) | (0x3708 << 16);
		...
		[MapiPropDef] public const int RenderingPosition                        =  ((int) PropertyType.Int32)    | (0x370B << 16);
		[MapiPropDef] public const int AttachTransportName                      =  ((int) PropertyType.Unicode) | (0x370C << 16);
		...
		[MapiPropDef] public const int AttachLongPathname                       =  ((int) PropertyType.Unicode) | (0x370D << 16);
		...
		[MapiPropDef] public const int AttachMimeTag                            =  ((int) PropertyType.Unicode) | (0x370E << 16);
		...
		[MapiPropDef] public const int DisplayType                              =  ((int) PropertyType.Int32)    | (0x3900 << 16);
		...
		[MapiPropDef] public const int Account                                  =  ((int) PropertyType.Unicode) | (0x3A00 << 16);
		...
		[MapiPropDef] public const int CallbackTelephoneNumber                  =  ((int) PropertyType.Unicode) | (0x3A02 << 16);
		...
		[MapiPropDef] public const int Generation                               =  ((int) PropertyType.Unicode) | (0x3A05 << 16);
		...
		[MapiPropDef] public const int GivenName                                =  ((int) PropertyType.Unicode) | (0x3A06 << 16);
		...
		[MapiPropDef] public const int GovernmentIdNumber                       =  ((int) PropertyType.Unicode) | (0x3A07 << 16);
		...
		[MapiPropDef] public const int BusinessTelephoneNumber                  =  ((int) PropertyType.Unicode) | (0x3A08 << 16);
		...
		[MapiPropDef] public const int HomeTelephoneNumber                      =  ((int) PropertyType.Unicode) | (0x3A09 << 16);
		...
		[MapiPropDef] public const int Initials                                 =  ((int) PropertyType.Unicode) | (0x3A0A << 16);
		...
		[MapiPropDef] public const int Keyword                                  =  ((int) PropertyType.Unicode) | (0x3A0B << 16);
		...
		[MapiPropDef] public const int Language                                 =  ((int) PropertyType.Unicode) | (0x3A0C << 16);
		...
		[MapiPropDef] public const int Location                                 =  ((int) PropertyType.Unicode) | (0x3A0D << 16);
		...
		[MapiPropDef] public const int MhsCommonName                            =  ((int) PropertyType.Unicode) | (0x3A0F << 16);
		...
		[MapiPropDef] public const int OrganizationalIdNumber                   =  ((int) PropertyType.Unicode) | (0x3A10 << 16);
		...
		[MapiPropDef] public const int Surname                                  =  ((int) PropertyType.Unicode) | (0x3A11 << 16);
		...
		[MapiPropDef] public const int OriginalDisplayName                      =  ((int) PropertyType.Unicode) | (0x3A13 << 16);
		...
		[MapiPropDef] public const int PostalAddress                            =  ((int) PropertyType.Unicode) | (0x3A15 << 16);
		...
		[MapiPropDef] public const int CompanyName                              =  ((int) PropertyType.Unicode) | (0x3A16 << 16);
		...
		[MapiPropDef] public const int Title                                    =  ((int) PropertyType.Unicode) | (0x3A17 << 16);
		...
		[MapiPropDef] public const int DepartmentName                           =  ((int) PropertyType.Unicode) | (0x3A18 << 16);
		...
		[MapiPropDef] public const int OfficeLocation                           =  ((int) PropertyType.Unicode) | (0x3A19 << 16);
		...
		[MapiPropDef] public const int PrimaryTelephoneNumber                   =  ((int) PropertyType.Unicode) | (0x3A1A << 16);
		...
		[MapiPropDef] public const int Business2TelephoneNumber                 =  ((int) PropertyType.Unicode) | (0x3A1B << 16);
		...
		[MapiPropDef] public const int MobileTelephoneNumber                    =  ((int) PropertyType.Unicode) | (0x3A1C << 16);
		...
		[MapiPropDef] public const int RadiotelephoneNumber                     =  ((int) PropertyType.Unicode) | (0x3A1D << 16);
		...
		[MapiPropDef] public const int CarTelephoneNumber                       =  ((int) PropertyType.Unicode) | (0x3A1E << 16);
		...
		[MapiPropDef] public const int OtherTelephone_number                    =  ((int) PropertyType.Unicode) | (0x3A1F << 16);
		...
		[MapiPropDef] public const int TransmitableDisplayName                  =  ((int) PropertyType.Unicode) | (0x3A20 << 16);
		...
		[MapiPropDef] public const int PagerTelephoneNumber                     =  ((int) PropertyType.Unicode) | (0x3A21 << 16);
		...
		[MapiPropDef] public const int PrimaryFaxNumber                         =  ((int) PropertyType.Unicode) | (0x3A23 << 16);
		...
		[MapiPropDef] public const int BusinessFaxNumber                        =  ((int) PropertyType.Unicode) | (0x3A24 << 16);
		...
		[MapiPropDef] public const int HomeFaxNumber                            =  ((int) PropertyType.Unicode) | (0x3A25 << 16);
		...
		[MapiPropDef] public const int Country                                  =  ((int) PropertyType.Unicode) | (0x3A26 << 16);
		...
		[MapiPropDef] public const int Locality                                 =  ((int) PropertyType.Unicode) | (0x3A27 << 16);
		...
		[MapiPropDef] public const int StateOrProvince                          =  ((int) PropertyType.Unicode) | (0x3A28 << 16);
		...
		[MapiPropDef] public const int StreetAddress                            =  ((int) PropertyType.Unicode) | (0x3A29 << 16);
		...
		[MapiPropDef] public const int PostalCode                               =  ((int) PropertyType.Unicode) | (0x3A2A << 16);
		...
		[MapiPropDef] public const int PostOfficeBox                            =  ((int) PropertyType.Unicode) | (0x3A2B << 16);
		...
		[MapiPropDef] public const int TelexNumber                              =  ((int) PropertyType.Unicode) | (0x3A2C << 16);
		...
		[MapiPropDef] public const int IsdnNumber                               =  ((int) PropertyType.Unicode) | (0x3A2D << 16);
		...
		[MapiPropDef] public const int AssistantTelephoneNumber                 =  ((int) PropertyType.Unicode) | (0x3A2E << 16);
		...
		[MapiPropDef] public const int Home2TelephoneNumber                     = ((int) PropertyType.Unicode)  | (0x3A2F << 16);
		...
		[MapiPropDef] public const int Assistant                                =  ((int) PropertyType.Unicode) | (0x3A30 << 16);
		...
		[MapiPropDef] public const int Hobbies                                  =  ((int) PropertyType.Unicode) |  (0x3A43 << 16);
		...
		[MapiPropDef] public const int MiddleName                               =  ((int) PropertyType.Unicode) |  (0x3A44 << 16);
		...
		[MapiPropDef] public const int DisplayNamePrefix                        =  ((int) PropertyType.Unicode) |  (0x3A45 << 16);
		...
		[MapiPropDef] public const int Profession                               =  ((int) PropertyType.Unicode) |  (0x3A46 << 16);
		...
		[MapiPropDef] public const int PreferredByName                          =  ((int) PropertyType.Unicode) |  (0x3A47 << 16);
		...
		[MapiPropDef] public const int SpouseName                               =  ((int) PropertyType.Unicode) |  (0x3A48 << 16);
		...
		[MapiPropDef] public const int ComputerNetworkName                      =  ((int) PropertyType.Unicode) |  (0x3A49 << 16);
		...
		[MapiPropDef] public const int CustomerId                               =  ((int) PropertyType.Unicode) |  (0x3A4A << 16);
		...
		[MapiPropDef] public const int TtytddPhoneNumber                        =  ((int) PropertyType.Unicode) |  (0x3A4B << 16);
		...
		[MapiPropDef] public const int FtpSite                                  =  ((int) PropertyType.Unicode) |  (0x3A4C << 16);
		...
		[MapiPropDef] public const int Gender                                   =  ((int) PropertyType.Int16)   |  (0x3A4D << 16);

		[MapiPropDef] public const int ManagerName                              =  ((int) PropertyType.Unicode) |  (0x3A4E << 16);
		...
		[MapiPropDef] public const int Nickname                                 =  ((int) PropertyType.Unicode) |  (0x3A4F << 16);
		...
		[MapiPropDef] public const int PersonalHomePage                         =  ((int) PropertyType.Unicode) |  (0x3A50 << 16);
		...
		[MapiPropDef] public const int BusinessHomePage                         =  ((int) PropertyType.Unicode) |  (0x3A51 << 16);
		...
		[MapiPropDef] public const int ContactAddrtypes                         =  ((int) PropertyType.MvUnicode) | (0x3A54 << 16);
		...
		[MapiPropDef] public const int ContactDefaultAddressIndex               =  ((int) PropertyType.Int32)      | (0x3A55 << 16);

		[MapiPropDef] public const int ContactEmailAddresses                    =  ((int) PropertyType.MvUnicode) | (0x3A56 << 16);
		...
		[MapiPropDef] public const int CompanyMainPhoneNumber                   =  ((int) PropertyType.Unicode)   |  ( 0x3A57 << 16);
		...
		[MapiPropDef] public const int ChildrensNames                           =  ((int) PropertyType.MvUnicode) |  ( 0x3A58 << 16);
		...
		[MapiPropDef] public const int HomeAddressCity                          =  ((int) PropertyType.Unicode) |  (0x3A59 << 16);
		...
		[MapiPropDef] public const int HomeAddressCountry                       =  ((int) PropertyType.Unicode) |  (0x3A5A << 16);
		...
		[MapiPropDef] public const int HomeAddressPostalCode                    =  ((int) PropertyType.Unicode) |  (0x3A5B << 16);
		...
		[MapiPropDef] public const int HomeAddressStateOrProvince               =  ((int) PropertyType.Unicode) |  (0x3A5C << 16);
		...
		[MapiPropDef] public const int HomeAddressStreet                        =  ((int) PropertyType.Unicode) |  (0x3A5D << 16);
		...
		[MapiPropDef] public const int HomeAddressPostOfficeBox                 =  ((int) PropertyType.Unicode) |  (0x3A5E << 16);
		...
		[MapiPropDef] public const int OtherAddressCity                         =  ((int) PropertyType.Unicode) |  (0x3A5F << 16);
		...
		[MapiPropDef] public const int OtherAddressCountry                      =  ((int) PropertyType.Unicode) |  (0x3A60 << 16);
		...
		[MapiPropDef] public const int OtherAddressPostalCode                   =  ((int) PropertyType.Unicode) |  (0x3A61 << 16);
		...
		[MapiPropDef] public const int OtherAddressStateOrProvince              =  ((int) PropertyType.Unicode) |  (0x3A62 << 16);
		...
		[MapiPropDef] public const int OtherAddressStreet                       =  ((int) PropertyType.Unicode) |  (0x3A63 << 16);
		...
		[MapiPropDef] public const int OtherAddressPostOfficeBox                =  ((int) PropertyType.Unicode) |  (0x3A64 << 16);
		...
		[MapiPropDef] public const int ServiceName                              =  ((int) PropertyType.Unicode) | (0x3D09 << 16);
		...
		[MapiPropDef] public const int ServiceDllName                           =  ((int) PropertyType.Unicode) | (0x3D0A << 16);
		...
		[MapiPropDef] public const int ServiceSupportFiles                      =  ((int) PropertyType.MvUnicode) | (0x3D0F << 16);
		...
		[MapiPropDef] public const int ServiceDeleteFiles                       =  ((int) PropertyType.MvUnicode) | (0x3D10 << 16);
		...
		[MapiPropDef] public const int ProfileName                              =  ((int) PropertyType.Unicode) | (0x3D12 << 16);
		...
		[MapiPropDef] public const int IdentityDisplay                          =  ((int) PropertyType.Unicode) | (0x3E00 << 16);
		...
		[MapiPropDef] public const int ResourceMethods                          =  ((int) PropertyType.Int32)    | (0x3E02 << 16);
		[MapiPropDef] public const int ResourceType                             =  ((int) PropertyType.Int32)    | (0x3E03 << 16);
		[MapiPropDef] public const int StatusCode                               =  ((int) PropertyType.Int32)    | (0x3E04 << 16);
		...
		[MapiPropDef] public const int ResourcePath                             =  ((int) PropertyType.Unicode) | (0x3E07 << 16);
		...
		[MapiPropDef] public const int StatusString                             =  ((int) PropertyType.Unicode) | (0x3E08 << 16);
		...
		[MapiPropDef] public const int RemoteProgress                           =  ((int) PropertyType.Int32)    | (0x3E0B << 16);
		[MapiPropDef] public const int RemoteProgressText                       =  ((int) PropertyType.Unicode) | (0x3E0C << 16);
		...
		[MapiPropDef] public const int ControlFlags                             =  ((int) PropertyType.Int32)    | (0x3F00 << 16);
		[MapiPropDef] public const int ControlStructure                         =  ((int) PropertyType.Binary)  | (0x3F01 << 16);
		[MapiPropDef] public const int ControlType                              =  ((int) PropertyType.Int32)    | (0x3F02 << 16);
		[MapiPropDef] public const int DeltaX                                   =  ((int) PropertyType.Int32)    | (0x3F03 << 16);
		[MapiPropDef] public const int DeltaY                                   =  ((int) PropertyType.Int32)    | (0x3F04 << 16);
		[MapiPropDef] public const int XPos                                     =  ((int) PropertyType.Int32)    | (0x3F05 << 16);
		[MapiPropDef] public const int YPos                                     =  ((int) PropertyType.Int32)    | (0x3F06 << 16);
		[MapiPropDef] public const int ControlId                                =  ((int) PropertyType.Binary)  | (0x3F07 << 16);
		[MapiPropDef] public const int Initialdetailspane                       =  ((int) PropertyType.Int32)    | (0x3F08 << 16);
		...
		[MapiPropDef] public const int AdditionalRenEntryId                 	              =  ((int) PropertyType.MvBinary)  | (0x36D8 << 16);
		[MapiPropDef] public const int AdditionalRenEntryIdEx                   	          =  ((int) PropertyType.Binary)  | (0x36D9 << 16);
		[MapiPropDef] public const int ChangeKey                              				  =  ((int) PropertyType.Binary)  | (0x65e2 << 16);
		[MapiPropDef] public const int RemOnlineEntryId                              		  =  ((int) PropertyType.Binary)  | (0x36D5 << 16);
		[MapiPropDef] public const int RemOfflineEntryId                              		  =  ((int) PropertyType.Binary)  | (0x36D6 << 16);

		[MapiPropDef] public const int ExtendedFolderTypeFlags                        		  =  ((int) PropertyType.Binary)  | (0x36DA << 16);
		[MapiPropDef] public const int FolderViewList                    	          		  =  ((int) PropertyType.Binary)  | (0x36EB << 16); // correct?
		[MapiPropDef] public const int FreeBusyEntryIds                              		  =  ((int) PropertyType.MvBinary)  | (0x36E4 << 16);

		// ICS-related
		[MapiPropDef] public const int LocalCommitTimeMax                              		  =  ((int) PropertyType.SysTime)  | (0x670A << 16); // correct?
		[MapiPropDef] public const int SourceKey                  		            		  =  ((int) PropertyType.Binary)  | (0x65E0 << 16); // 22 bytes lenghth (storeid + some id)...
		[MapiPropDef] public const int ParentSourceKey                  	        		  =  ((int) PropertyType.Binary)  | (0x65E1 << 16); 
