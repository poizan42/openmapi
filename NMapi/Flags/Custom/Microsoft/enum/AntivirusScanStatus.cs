//
// openmapi.org - NMapi C# Mapi API - AntivirusScanStatus.cs
//
...
namespace NMapi.Flags {
	...
	public enum AntivirusScanStatus
	{
		...
		/// <summary>
		///  A virus has been detected and the object must be deleted
		///  because cleaning is not possible or allowed.
		/// </summary>
		VirusDeleted = 3
	}
