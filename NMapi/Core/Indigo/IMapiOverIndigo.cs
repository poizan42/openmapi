...
namespace NMapi {
	...
	public interface IMapiOverIndigo
	{
		...
		[OperationContract]
		[FaultContract (typeof (MapiIndigoFault))]
		IndigoMapiObjRef IMapiFolder_CreateFolder (IndigoMapiObjRef obj, FolderType folderType, string folderName, string folderComment, NMapiGuid interFace, int flags);
