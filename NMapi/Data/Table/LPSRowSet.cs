//
// openmapi.org - NMapi C# Mapi API - LPSRowSet.cs
//
...
namespace NMapi.Interop {
	...
	/// </summary>
	public sealed class LPSRowSet : IXdrAble
	{
		private SRowSet _value;

		/// <summary>
		///   
		/// </summary>
		public SRowSet Value {
			get { return _value; }
			set { _value = value; }
		}
		...
		///
		/// </summary>
		public LPSRowSet (SRowSet value) {
			this._value = value;
		}
		...
		///
		/// </summary>
		public LPSRowSet(XdrDecodingStream xdr)
		{
			XdrDecode(xdr);
		}
		...
		public void XdrDecode (XdrDecodingStream xdr)
		{
			...
			if (len == ~0)
				...
				_value = new SRowSet ();
				_value.ARow = new SRow [len];
				for (int idx = 0; idx < len; idx++)
					_value.ARow [idx] = new SRow (xdr);
			}
		}
	}
