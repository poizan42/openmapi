...
namespace NMapi.Provider.Indigo.Properties {
	...
	public class IndigoMapiProp : IndigoBase, IMapiProp
	{
		...
		{
			try {
				return session.Proxy.IMapiProp_HrGetOneProp (obj, tag);
			} catch (FaultException<MapiIndigoFault> e) {
				throw new MapiException (e.Detail.Message, e.Detail.HResult);
			}
		}
		...
		{
			try {
				return session.Proxy.IMapiProp_HrGetOnePropNull (obj, tag);
			} catch (FaultException<MapiIndigoFault> e) {
				throw new MapiException (e.Detail.Message, e.Detail.HResult);
			}
		}
		...
		{
			try {
				session.Proxy.IMapiProp_HrSetOneProp (obj, prop);
			} catch (FaultException<MapiIndigoFault> e) {
				throw new MapiException (e.Detail.Message, e.Detail.HResult);
			}
		}
		...
		{
			try {
				session.Proxy.IMapiProp_HrDeleteOneProp (obj, propTag);
			} catch (FaultException<MapiIndigoFault> e) {
				throw new MapiException (e.Detail.Message, e.Detail.HResult);
			}
		}
		...
		{
			try {
				return session.Proxy.IMapiProp_HrGetNamedProp (obj, mnid);
			} catch (FaultException<MapiIndigoFault> e) {
				throw new MapiException (e.Detail.Message, e.Detail.HResult);
			}
		}
		...
		{
			try {
				return session.Proxy.IMapiProp_HrGetNamedProp_2_str (obj, guid, name);
			} catch (FaultException<MapiIndigoFault> e) {
				throw new MapiException (e.Detail.Message, e.Detail.HResult);
			}
		}
		...
		{
			try {
				return session.Proxy.IMapiProp_HrGetNamedProp_2_int (obj, guid, id);
			} catch (FaultException<MapiIndigoFault> e) {
				throw new MapiException (e.Detail.Message, e.Detail.HResult);
			}
		}
